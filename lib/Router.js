...
Router.prototype.enterStates = Promise.method(function enterStates(stateList, pushHistory)
{
        ...
        .then(function()
        {
                this._pushHistoryState(this._pendingReplace || stateList, pushHistory);
        })
        .finally(function()
        {
                this._pendingReplace = null;
...
Router.prototype.replaceStateList = function(stateList)
{
        ...
        {
                this._pushHistoryState(stateList, false);
        }
};
...
Router.prototype._handleHistoryState = function(historyState, upgrade, event)
{
        ...
        if (this.pending)
        {
                promise = this._addToQueue(stateList, true, upgrade, false);
        }
        else
        {
...
Router.prototype._doQueuedTransition = function()
{
        ...
        .then(function()
        {
                if (!fromHistory)
                {
                        this._pushHistoryState(this._pendingReplace || stateList, push);
                }
        })
        .finally(function()
        {
